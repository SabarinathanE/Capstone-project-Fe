...
import { registerUser } from "../API/help";
        ...
        <div className="register rounded-3xl">     
            <div className="card-section card-glass">
                ...
                <div className="card-body">
                    <input value={values.firstName} name="firstName" onBlur={handleBlur} onChange={handleChange} type="text" style={{color:"white"}} placeholder="First Name" className="skeleton input text-center input-bordered input-secondary w-full max-w-xs" />
                    {touched.firstName && errors.firstName?(<div className="text-secondary">{errors.firstName}</div>):""}
                    <input value={values.lastName} name="lastName" onBlur={handleBlur} onChange={handleChange} type="text" style={{color:"white"}} placeholder="Last Name" className="skeleton input text-center input-bordered input-secondary w-full max-w-xs" />
                    {touched.lastName && errors.lastName?(<div className="text-secondary">{errors.lastName}</div>):""}
                    <input value={values.email} name="email" onBlur={handleBlur} onChange={handleChange} type="text" style={{color:"white"}} placeholder="Email Address" className="skeleton input text-center input-bordered input-secondary w-full max-w-xs" />
                    {touched.email && errors.email?(<div className="text-secondary">{errors.email}</div>):""}
                    <input value={values.password} name="password" onBlur={handleBlur} onChange={handleChange} type="password" style={{color:"white"}} placeholder="Password" className="skeleton input text-center input-bordered input-secondary w-full max-w-xs" />
