...
import { deleteTasks, getAllTasks, getNotCompletedTasks, updateStatus } from "../API/help";
...
export default function TasksPage(){
    ...
    useEffect(()=>{
      ...
      getNotCompletedTasks().then((result)=>{
    ...
    //setting condition as if there is no token data from the local storage
      if(!localStorage.getItem("token")){
        ...
        Swal.fire({
            icon: "error",
            title: "Login to See Your Pending Tasks",
    ...
    async function statusUpdate(e, d) {
      ...
      if (e.target.value == "Completed"){
        const details = {
          ...
          const ress = await getNotCompletedTasks().then((result)=>{
              ...
              return (
                ...
                <div key={index} className="card mb-3">
                  ...
                  <div className="card-body">
                    ...
                    <div className="card subject-alt" style={{background: "#389d8e"}}>
